        ...
        <div class="container-fluid px-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="add-laporan-guru.php" class="btn btn-sm btn-primary float-end ms-1"><i class="fa-solid fa-plus"></i> Tambah Laporan Mengaji</a>
                </div>
                <div class="card-body">
                            ...
                            while ($data = mysqli_fetch_array($queryLaporan)) { ?>
                                <tr>
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="update-laporan-guru.php?id=<?= urlencode($data['id']) ?>" class="btn btn-sm btn-warning" title="Update Laporan Mengaji"><i class="fa-solid fa-pen"></i></a>
                                        <a href="hapus-laporan-guru.php?id=<?= urlencode($data['id']) ?>" class="btn btn-sm btn-danger" title="Hapus Laporan Mengaji" onclick="return confirm('Anda yakin akan menghapus data ini?')"><i class="fa-solid fa-trash"></i></a>
                                    </div>
                                    </td>
                                </tr>
                            <?php } ?>
