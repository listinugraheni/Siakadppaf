...
if (isset($_POST['simpan'])) {
    ...
    if (!password_verify($curPass, $data['password'])) {
        ...
        header('Location: ganti-password-santri.php?msg=updated');
        exit;
    }
}
?>
