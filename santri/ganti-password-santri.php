...
$title = "Ganti Password - SIA TPA PP.AL-FALAH";
require_once '../template/header.php';
require_once "../template/navbarsantri.php";
require_once "../template/sidebarsantri.php";

// Bagian alert message
if (isset ($_GET['msg'])) {
    $msg = $_GET['msg'];
} else {
    $msg = '';
...
if ($msg == 'err2') {
    $alert ='<div class="alert alert-danger alert-dismissible fade show" role="alert">
    Ganti password gagal, Password lama tidak cocok..
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
?>
              ...
              <main>
                 <div class="container-fluid px-4">
                   <h1 class="mt-4">Password</h1>
                    ...
                    <form action="proses-passwordsantri.php" method="POST">
                    <?php
                        if ($msg !== '') {
                            echo $alert;
                        }  
